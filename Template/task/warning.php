...
<p class="alert">
    <?= t("Dear administrator"); ?> <b><?php print ($user['name']); ?></b>, <?= t("please read this recommendations before updating the task creation date."); ?>
</p>
<h2><?= t("Why do that?"); ?></h2>
<p class="alert">
...
<h2><?= t("Who can do that?"); ?></h2>
<p class="alert">
    <?= t("It should be done only by administrators and when there is a need to include an old task or when you forget to create a task at the right time." ); ?>
</p>
<h2><?= t("Changes will affect your team performance"); ?></h2>
<p class="alert">
...
<h2><?= t("Everything will be recorded"); ?></h2>
<p class="alert">
    <?= t("Keep in mind that every change (who did it and when did it) will be recorded at the page"); ?>
...
autocomplete="off">    
    <div style="text-align:center">
        <?= $this->modal->submitButtons(array('tabindex' => 13, 'color'=>'red', 'submitLabel' => t('Go to the updating page'))) ?>
    </div>
</form>
